  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <p><span role="img" aria-label="wave emoji">👋</span><a href="https://reactjs.org/" target="__blank"rel="noopener noreferrer">Django</a> is a <a href="https://hackernoon.com/what-is-a-web-framework-173cac228b4" target="__blank" rel="noopener noreferrer">web framework</a>
        developed entirely in <Link to="/blog/history-of-python-programming-language/">python programming language</Link>.
         It follows the Model View Template (MVT) architecture. Django comes packed with features and ready to use components,
         plug and play staff. Examples are<span role="img" aria-label="wave emoji">👋</span>a template engine that uses jinja syntax and allows you to extend pages and
         inject python inside HTML, <span role="img" aria-label="wave emoji">👋</span>a URL system that allows you to design elegant web addresses without any difficulties,
         ...
         <span role="img" aria-label="wave emoji">👋</span>a ready to use dashboard that you can use for content management. It's also easy to <Link to="/blog/django-with-bootstrap-4/">add bootstrap 4 into your forms</Link> and templates using third part application like django crispy forms.
